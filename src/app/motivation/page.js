        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-700 mt-5 max-w-3xl mx-auto leading-8">
              ...
              सेवा, जागरूकता और संगठन से होता है।
              हमारा उद्देश्य समाज में सकारात्मक परिवर्तन लाना है।
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {[
                ...
                },
                {
                  icon: "🇮🇳",
                  title: "राष्ट्र सेवा",
                  desc: "राष्ट्रहित को सर्वोपरि मानकर कार्य करना।",
                },
                {
                  icon: "🔥",
                  title: "जागरूकता",
          ...
          <div className="mt-20 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8">
              ...
              <p className="text-gray-700 text-lg leading-8">
                आज समाज को जागरूकता, अनुशासन और संगठन की आवश्यकता है।
                युवाओं को सही दिशा और सकारात्मक सोच के साथ जोड़ना
